<Query Kind="Program">
  <Reference Relative="FastMember.dll">\\sqlclient\c$\CustomLoader\FastMember.dll</Reference>
  <Reference Relative="Newtonsoft.Json.dll">\\sqlclient\c$\CustomLoader\Newtonsoft.Json.dll</Reference>
  <Reference Relative="System.Data.HashFunction.CityHash.dll">\\sqlclient\c$\CustomLoader\System.Data.HashFunction.CityHash.dll</Reference>
  <Reference Relative="System.Data.HashFunction.Interfaces.dll">\\sqlclient\c$\CustomLoader\System.Data.HashFunction.Interfaces.dll</Reference>
...
{
	public static string SQLConnStr = @"Server=SQLSATVM;Initial Catalog=OpenAcademicGraph;Integrated Security=true;Connection Timeout=60";
